...
|exportMissingReferences    |String                     |If target attribute type is a reference attribute, and referenced object is missing in the target directory, attempt to create such an object. <!-- I'm not sure how this is different than beta APIs in general; the beta APIs are not recommended for use in production apps. ***Experimental, not recommended for use.*** -->|
