...

{
    ...
    "schema@odata.context": "https://graph.microsoft.com/testSynchronization/$metadata#servicePrincipals('167e33e9-f80e-490e-b4d8-698d4a80fb3e')/synchronization/templates('SfOutDelta')/schema/$entity",
    "schema": {
        "provisioningTaskIdentifier": "SfOutDelta.00000000000000000000000000000000",
        "directories": [
            {
